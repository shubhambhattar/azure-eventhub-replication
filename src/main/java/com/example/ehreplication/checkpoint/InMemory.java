package com.example.ehreplication.checkpoint;
...
@Configuration
public class InMemory implements CheckpointStore {
    ...
    private final ClientLogger logger = new ClientLogger(InMemory.class);
    ...
    public Flux<PartitionOwnership> claimOwnership(List<PartitionOwnership> requestedPartitionOwnerships) {
        ...
        return Flux.fromIterable(requestedPartitionOwnerships)
                .filter(partitionOwnership -> !partitionOwnershipMap.containsKey(partitionOwnership.getPartitionId())
